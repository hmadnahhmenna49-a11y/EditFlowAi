                ...
                {formState === 'sent' ? (
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid sm:grid-cols-2 gap-6">
                      <div>
                        <label htmlFor="page-name" className="block text-sm text-gray-300 mb-2">
                          Nombre completo
                        </label>
                        <input
                          type="text"
                      ...
                      <div>
                        <label htmlFor="page-email" className="block text-sm text-gray-300 mb-2">
                          Email corporativo
                        </label>
                        <input
                          type="email"
                    ...
                    <div>
                      <label htmlFor="page-subject" className="block text-sm text-gray-300 mb-2">
                        Asunto
                      </label>
                      <select
                        id="page-subject"
                    ...
                    <div>
                      <label htmlFor="page-message" className="block text-sm text-gray-300 mb-2">
              ...
              <div className="bg-brand-card border border-white/5 rounded-2xl p-6 sm:p-8 space-y-6 glass">
                ...
                <div className="space-y-4">
                  <a
                    ...
                    className="flex items-center gap-4 text-gray-300 hover:text-brand-purple transition-colors group card-hover-lift"
                  >
